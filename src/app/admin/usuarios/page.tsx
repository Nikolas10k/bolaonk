...
export default async function AdminUsuarios() {
  ...
  return (
    <div>
      ...
      <p className="text-muted mb-6">Controle de pagamentos por rodada via PIX.</p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
          <thead style={{ backgroundColor: 'var(--background)' }}>
            <tr>
              ...
              <th style={{ padding: '1rem', borderBottom: '1px solid var(--border)' }}>Rodada</th>
            ...
            {pagamentos.map((p, i) => {
              ...
              return (
                <tr key={p.id} style={{ borderBottom: i < pagamentos.length - 1 ? '1px solid var(--border)' : 'none' }}>
                  ...
                  <td style={{ padding: '1rem', fontWeight: 600 }}>Rodada {p.data_referencia}</td>
                  <td style={{ padding: '1rem' }}>
